...
export default function TransfersLanding()
{
  let date= new Date();
    ...
    <Flex direction="row" gap="size-100" >
      ...
      <Flex direction="column" gap="size-100" width={{XXS:'70%',XS:'70%',S:'70%',M:'70%',L:'70%'}}>
        <Well><View ><Heading level={5}><Sync/> Transactions <ChevronRight/>Transfers in {monthNames[date.getMonth()]} Month </Heading>  </View></Well>
      <TransfersList/>
    </Flex></Flex>
  </Flex>
}